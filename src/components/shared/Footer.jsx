    ...
    <footer className="border-t border-white/10 bg-[#06153a] text-white mt-20">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h3 className="font-semibold mb-4 text-white">Start Learning</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-center text-sm text-gray-400">
